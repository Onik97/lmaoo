          ...
          <div class="card-body">
            ...
            <form id="registerForm" name="registerForm" action="target.php" method='POST'>
              ...
              <input type="hidden" name="function" value="register">
                <button id="registerBtn" type="submit" value="Submit" class="btn btn-success btn-block" disabled>Register</button>
              <small id="validateMessage" hidden></small>

              <div class="form-group mt-3">
                <a class="register" href="/login">Already Registered? Login here!</a>
              </div>
