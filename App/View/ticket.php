	...
	<div class="row no-gutters">
		<div id="info" class="col-sm-12 col-md-3">
			...
			<div class="p-4">
				...
				<button id="changeProgressBtn" class="btn btn-sm" onclick="changeProgress()">Update Status</button>
			</div>
		</div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title ml-9 mr-auto text-white" id="Modal-head"><b></b></h5>
